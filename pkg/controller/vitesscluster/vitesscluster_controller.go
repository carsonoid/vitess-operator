...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner VitessCluster
...
func (r *ReconcileVitessCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &vitessv1alpha2.VitessCluster{}
...
func newPodForCR(cr *vitessv1alpha2.VitessCluster) *corev1.Pod {
